...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val editPassword = ObjectAnimator.ofFloat(binding.editPassword, View.ALPHA, 1f).setDuration(500)
        val confirmPassword = ObjectAnimator.ofFloat(binding.tvKonfirmasiPassword, View.ALPHA, 1f).setDuration(500)
        val editConfirmPass = ObjectAnimator.ofFloat(binding.editKonfirmasiPassword, View.ALPHA, 1f).setDuration(500)
