package com.example.husnistoryapp.ui.maps
...
import com.example.husnistoryapp.databinding.ActivityMapsBinding
        ...
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(
                MarkerOptions()
                    ...
                    .icon(vectorToBitmap(R.drawable.ic_marker, Color.parseColor("#FF0000")))
            )
        }
            ...
            it?.listStory?.forEach { list ->
                mMap.addMarker(
                    MarkerOptions()
                        ...
                        .snippet("Description : ${list.description}")
                        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN))
                )
                boundsBuilder.include(LatLng(list.lat, list.lon))
            }
